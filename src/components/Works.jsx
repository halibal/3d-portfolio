    ...
    return (
        <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
            <Tilt
                ...
                className="bg-tertiary p-5 rounded-2xl sm:w-[360px] h-full w-full flex flex-col gap-5"
            >
        ...
        <>
            ...
            <div className="w-full flex">
                <motion.p
                    ...
                    className="mt-3 text-secondary text-[17px] text-justify w-full leading-[30px]"
                >
                    {aboutMe.projectsDescriptionAlt}
                </motion.p>
            </div>
